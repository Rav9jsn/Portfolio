...
export const EXPERIENCES = [
  {
    ...
    company: "",
    description:
      "Built responsive and interactive web applications using JavaScript and React.js. Developed user-friendly interfaces with Tailwind CSS and optimized website performance. Worked on personal projects.",
    technologies: ["JavaScript", "React.js", "TailwindCSS", "HTML"],
  },
  // {
  //   year: "2022 - 2023",
